            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">(+32) 2 681 03 32</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">info@limousine.brussels</p>
                </div>
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                >
                  ...
                  <option value="business">Transport d'affaires</option>
                  <option value="events">Événements</option>
                  <option value="tours">Visites touristiques</option>
                </select>
              </div>
